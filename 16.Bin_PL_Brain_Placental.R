...
max(Mean_age) #195.050 is the oldest bin average for PL
...
Trait<-placental.data[12] # res PL-Brain
...
ggplot(Table2, aes(x=Average_Bin,y=Mean))+
  ...
  labs(x='Millions of years ago', y='Residuals log10(Petrosal lobule vs Endocranial volume)')+
  theme_classic()
